...
const HomePage = ({}: HomePageProps) => {
  ...
  return (
    <main>
      ...
      <section
        id="hero"
        className="relative flex overflow-hidden h-screen flex-col justify-center items-center bg-heroRed text-white text-center"
      >
        <div className="relative flex w-full h-full px-4 flex-col justify-center items-center">
          <div className="flex flex-row md:flex-row lg:flex-row justify-center items-center p-3 lg-p-0 md-p-0">
            <h1
          ...
          <div className="max-w-[800px] mx-auto text-center z-10 relative px-5">
            ...
            <p className="text-white text-lg mb-8 drop-shadow-[1px_1px_0_#000] hidden lg:block sm:block">
          ...
          <div className="flex flex-col md:flex-row lg:flex-row gap-5 z-10 relative">
